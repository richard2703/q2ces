...
class clientesController extends Controller {
    ...
    */
    ...
    public function create() {
        ...
        $vctFormasPago = satFormaPago::getListaFormasPago();
        $vctMetodosPago = satMetodoPago::getListaMetodosPago();
        $vctUsosCfdi = satUsoCfdi::getListaUsosCfdi();
        return view( 'clientes.altaCliente', compact('vctFormasPago', 'vctMetodosPago', 'vctUsosCfdi' ) );
    }
    ...
    */
    ...
    public function edit( clientes $cliente ) {
        ...
        $vctUsosCfdi = satUsoCfdi::getListaUsosCfdi();
        // dd( $residentes );
        return view( 'clientes.editCliente', compact( 'cliente', 'residentes', 'vctFormasPago', 'vctMetodosPago', 'vctUsosCfdi' ) );
    }
