                            ...
                            <form action="{{ route('residentes.store') }}"
                                ...
                                <div class="row mt-3" style="padding-left: 40px">
                                    <div class=" col-12 col-sm-6 mb-3 pr-3">
                                        ...
                                        <select name="provedorId" class="form-select" aria-label="Default select example">
                                    ...
                                    <div class=" col-12  mb-3 ">
                                        ...
                                        <textarea class="form-control border-green" placeholder="Comentarios del Respecto al Provedor..." id="floatingTextarea" name="comentario"
                                            spellcheck="true" readonly>{{ $provedorSelected->comentario }}</textarea>
                                    </div>
                                    {{--  <div class=" col-12 col-sm-6 mb-3 ">
                                                ...
                                                <div class="col-6 mb-3 ">
                                                    ...
                                                    <div style="display: flex; align-items: center;">
                                                        <label class="custom-file-upload" id='' onclick='handleDocumentoXML("xml-file-input", this)'>
                                                            <input class="mb-4" type="file" name="xml_file" id="xml-file-input"
                                                                accept=".xml">
