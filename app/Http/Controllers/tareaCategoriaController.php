...
class tareaCategoriaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // dd( $request );
        $request->validate([
            'nombre' => 'required|max:250|unique:tareaCategoria,nombre,' . $request['nombre'],
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'nombre' => 'required|max:250|unique:tareaCategoria,nombre,' . $request['controlId'],
            'comentario' => 'nullable|max:500',
        ], [
            'nombre.required' => 'El campo nombre es obligatorio.',
            'nombre.unique' => 'El valor del campo nombre ya esta en uso.',
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(tareaCategoria $tareaCategorium)
    {

        try {
            $tareaCategorium->delete(); // Intenta eliminar 
