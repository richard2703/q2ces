@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Refacciones')])
@section('content')
    <div class="content">
        @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <div class="d-flex p-3 ">
                                            <div class="col-12 text-right">
                                                ...
                                                <a href="{{ route('catalogos.index', ['seccion' => 'maquinaria']) }}">
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_edit')
                                                            <a href="#" class="" data-bs-toggle="modal"
                                                                ...
                                                                onclick="cargaItem('{{ $item->id }}','{{ $item->nombre }}','{{ $item->numeroParte }}','{{ $item->marcaId }}','{{ $item->tipoRefaccionId }}','{{ $item->maquinariaId }}','{{ $item->comentario }}')">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('refacciones.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nuevo Refacción</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('refacciones.store') }}" method="post">
                        @csrf
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            ...
                            <select id="tipoRefaccionId" name="tipoRefaccionId" class="form-select" required
                                aria-label="Default select example">
                                <option value="">Seleccione</option>
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Maquinaría: <span>*</span></label></br>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Refacción</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('refacciones.update', 0) }}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            ...
                            <select id="controlMarcaId" name="marcaId" class="form-select" required
                                aria-label="Default select example">
                                <option value="">Seleccione</option>
                                @foreach ($vctMarcas as $item)
                                    <option value="{{ $item->id }}">
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Maquinaría: <span>*</span></label></br>
                            <select id="controlMaquinariaId" name="maquinariaId" class="form-select" required
                                aria-label="Default select example">
                                <option value="">Seleccione</option>
                                @foreach ($vctMaquinaria as $item)
                                    <option value="{{ $item->id }}">
    ...
    <script>
        function cargaItem(id, nombre, numeroParte, marcaId, tipoId, maquinariaId, comentarios) {
            ...
            const txtNumeroParte = document.getElementById('controlNumeroParte');
            txtNumeroParte.value = numeroParte;

            const lstMarca = document.getElementById('controlMarcaId').value = marcaId;
            const lstTipo = document.getElementById('controlTipoRefaccionId').value = tipoId;
            const lstMaquinaria = document.getElementById('controlMaquinariaId').value = maquinariaId;
