@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Categorías de Maquinaría')])
@section('content')
    <div class="content">
        @if ($errors->any())
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Tipos de Almacenes/Tiraderos</h4>
                                            ...
                                            <div class="col-12 text-right">
                                                ...
                                                @can('catalogos_create')
                                                    <button class="btn botonGral float-end" data-bs-toggle="modal"
                                                        ...
                                                        Añadir Tipo de Almacen
                                                    </button>
                                                @endcan
                                            </div>
                                        </div>
                                        <div class="divBorder">
                                            <p>Catálogo General de Tipos de Almacenes/Tiraderos, Es Utilizado para Asignar y
                                                Agrupar
                                                la los almacenes y tiraderos en Bloque de Datos.</p>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('tipoAlmacen.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nueva Categoría de Maquinaría</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoAlmacen.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Categoría de Maquinaría</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoAlmacen.update', 1) }}" method="post">
                        @csrf
                        @method('put')
