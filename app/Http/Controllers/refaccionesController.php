...
class refaccionesController extends Controller
{
    ...
    public function index()
    {
        ...
        $records = refacciones::orderBy('nombre', 'asc')->paginate(15);

        return view('catalogo.indexCatalogoRefacciones', compact('records'));
    }
    ...
    public function store(Request $request)
    {
        ...
        refacciones::create($record);
        Session::flash('message', 1);

        return redirect()->route('catalogoRefacciones.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $record = refacciones::where('id', $data['controlId'])->first();
    ...
    public function destroy(refacciones $refaccione)
    {
        try {
            $refaccione->delete(); // Intenta eliminar 
