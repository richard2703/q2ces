                            ...
                            <div class="row d-flex ">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('calendario.index') }}" class="">
                                        <img src="/img/equipos/CALENDARIO-01.svg" alt="equipos" title="equipos" width="30%"
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('asistencia.index') }}" class="">
                                        <img src="/img/equipos/CATEGORÍA DE TAREAS-01.svg" alt="personal" title="personal" width="30%"
                                            class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('cajaChica.index') }}" class="">
                                        <img src="/img/inventario/precio.svg" alt="inventario" title="inventario"
                                ...
                                <div class="col-12 col-md-6  col-lg-3 text-center my-4">
                                    <a href="{{ route('tarea.index') }}" class="">
                                        <img src="/img/equipos/TIPOS DE TAREAS-01.svg" alt="formatos" title="formatos" width="30%"
                                            class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('accesorios.index') }}" class="">
                                        <img src="/img/equipos/REFACCIONES POR MAQUINARÍA-01.svg" alt="equipos" title="equipos" width="30%"
                                            class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('inventario.dash') }}" class="">
                                        <img src="/img/equipos/CATEGORÍAS DE PROVEEDORES-01.svg" alt="inventario" title="inventario"
                                            width="30%" class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('calendarioMtq.index') }}" class="">
                                        <img src="/img/equipos/CALENDARIO-01.svg" alt="inventario" title="inventario"
                                            width="30%" class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('uso.index') }}" class="">
                                        <img src="/img/equipos/SERVICIOS MTQ2.svg" alt="equipos" title="equipos" width="30%"
                                            class="botonIconoPrincipal">
                                ...
                                <div class="col-12 col-md-6 col-lg-3 text-center my-4">
                                    <a href="{{ route('catalogos.index') }}" class="">
                                        <img src="/img/equipos/ADMINISTRACIÓN DE DOCUMENTOS-01.svg" alt="bitacoras" title="bitacoras"
                                            width="30%" class="botonIconoPrincipal">
