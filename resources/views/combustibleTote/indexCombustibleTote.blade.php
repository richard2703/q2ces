                        ...
                        @can('combustible_create')
                            <div class="card-body contCart">
                                <div class="p-1 align-self-start bacTituloPrincipal">
                                    <h2 class="my-3 ms-3 texticonos ">Combustible Tote</h2>
                                </div>
                                ...
                                <div class="col-11  mx-auto d-block my-4 border-bottom">
                                    ...
                                    <div class="tab-content" id="nav-tabContent ">
                                        ...
                                        <div class="tab-pane fade show active conteDivCArgaDescarga " id="balanceUno"
                                            ...
                                            <form action="{{ route('combustibleTote.store') }}" method="post">
                                                @csrf
                                        ...
                                        <div class="tab-pane fade conteDivCArgaDescarga" id="balanceDos" role="tabpanel"
                                            ...
                                            <form action="{{ route('descarga.post') }}" id="combustibleForm" method="post"
                                                            ...
                                                            <div class="row ">
                                                                ...
                                                                <div class=" col-12 col-md-6 d-flex mb-4">
                                                                    ...
                                                                    <div style="width: 100%! important;">
                                                                        <label class="labelTitulo">Equipo:</label></br>
                                                                        <select id="maquinariaIdD" name="maquinariaId"
                                                                            class="form-select"
                                                                            aria-label="Default select example" required>
                                                                            <option value="">Seleccione</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#maquinariaIdC').on('change', function () {
                // Obtiene el valor del atributo 'data-odometro' de la opción seleccionada
                var selectedOption = $(this).find(':selected');
                var kmValue = selectedOption.data('horometro');
                
                // Actualiza el valor del input 'horometro'
                $('#horometroCarga').val(kmValue);
            });
        });
    </script>
