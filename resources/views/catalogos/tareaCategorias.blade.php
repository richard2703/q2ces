@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Categorías de Tareas')])
@section('content')
    <div class="content">
        @if ($errors->any())
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="divBorder">
                                            <p>Catálogo General de Categorías de Tareas, Es Utilizado para Agrupar las
                                                Tareas en un Bloque Especifico de Información de los CheckList.</p>
                                        </div>
                                    </div>
                                            ...
                                            @forelse ($records as $item)
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @endcan
                                                        @can('tarea_destroy')
                                                            <form action="{{ route('tareaCategoria.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nueva Categoría de Tareas</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tareaCategoria.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Categoría de Tareas</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tareaCategoria.update', 0) }}" method="post">
                        @csrf
                        @method('put')
