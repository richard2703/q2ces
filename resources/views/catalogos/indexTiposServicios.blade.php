                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="divBorder">
                                    <p>Catálogo General de Tipos de Servicio, Es Utilizado para Agrupar los Servicios en un
                                        Bloque Especifico de Información de los Mantenimientos.</p>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tiposServicios.update', 0) }}" method="post">
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Costo: <span>*</span></label></br>
                            <input type="number" class="inputCaja" id="controlCosto" name="costo" value="">
                        </div>
