@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Tipos de Uniforme')])
@section('content')
    <div class="content">
        @if ($errors->any())
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="divBorder">
                                            <p>Catálogo General de Tipos de Uniforme, Es Utilizado para Agrupar y/o
                                                Especificar en un Grupo a los Diferentes Tipos de Uniforme.</p>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('tipoUniforme.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nuevo Tipo de Uniforme</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoUniforme.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Tipo de Uniforme</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoUniforme.update', 0) }}" method="post">
                        @csrf
                        @method('put')
