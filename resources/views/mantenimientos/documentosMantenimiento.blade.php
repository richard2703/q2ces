                ...
                <div class="col-12 align-self-start">
                    <div class="card">
                        ...
                        <div class="ml-3">
                            ...
                            <form action="{{ route('documentoSelladoMantenimiento.update', $id) }}"
                                                            ...
                                                            @if (is_null($fotos) == false)
                                                                @forelse ($fotos as $foto)
                                                                    <img onclick="abre(this)"
                                                                        title=""
                                                                        src="{{ asset('/storage/maquinaria/' . str_pad($id, 4, '0', STR_PAD_LEFT) . '/mantenimientosDocumentoFirmado/' . $mantenimiento->codigo . '/' . $foto->ruta) }}"
