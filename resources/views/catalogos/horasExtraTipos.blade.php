...
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Tipos de Horas Extra</h4>
                                        ...
                                        <tbody>
                                            @forelse ($records as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-left">$ {{ number_format($item->valor, 2) }}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nuevo Tipo de Horas Extra</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoHoraExtra.store') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editarItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoHoraExtra.update', 0) }}" method="post">
                        @csrf
                        @method('put')
    ...
    <script>
        function cargaItem(id, nombre, valor,  comentarios) {
            ...
            const txtValor = document.getElementById('controlValor');
