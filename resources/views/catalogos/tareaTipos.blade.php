                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="divBorder">
                                            <p>Catálogo General de Tipos de Tareas, Es Utilizado para Asignar a las
                                                Tareas el Tipo de Acción a Realizar dentro de los CheckList.</p>
                                        </div>
                                    </div>
                                            ...
                                            @forelse ($records as $item)
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        {{-- @endcan --}}
                                                        @can('user_destroy')
                                                            <form action="{{ route('tareaTipo.destroy', $item->id) }}"
