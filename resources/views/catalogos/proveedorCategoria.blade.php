                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="divBorder">
                                            <p>Catálogo General de Tipos de Proveedor, Es Utilizado para Agrupar y/o
                                                Especificar en un Grupo a las Proveedores.</p>
                                        </div>
                                    </div>
                                            ...
                                            @forelse ($records as $item)
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        {{-- @endcan --}}
                                                        @can('user_destroy')
                                                            <form action="{{ route('proveedorCategoria.destroy', $item->id) }}"
