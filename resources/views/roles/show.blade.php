              ...
              <div class="row mt-3">
                ...
                <div class="col-sm-7">
                  <div class="form-group">
                    <input type="text" class="form-control inputCaja" name="name" value="{{ old('name', $role->name) }}" autocomplete="off" readonly>
                  </div>
                </div>
              </div>
              <div class="row mt-2">
                      ...
                      @foreach ($permissions as $id => $permission)
                          <div class="col-md-4 col-12 mb-2">
                              <div class="form-check">
                                  <label class="form-check-label" style="color: grey !important;">
                                      <input class="form-check-input permission-checkbox is-invalid align-self-end"
                                          type="checkbox" name="permissions[]" disabled
