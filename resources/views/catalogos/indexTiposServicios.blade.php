        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Añadir Tipo Servicio</h1>
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tiposServicios.store') }}" method="post">
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            ...
                            <input class="form-check-input is-valid align-self-end mb-2" type="checkbox" name="check" id="controlCheck"
