...
class calendarioController extends Controller
{
    ...
    public function index2($intAnio = null, $intMes = null)
    {
        abort_if(Gate::denies('calendario_index'), 403);
        ...
        return view('calendario.calendario2', compact('usuario', 'personal', 'maquinaria', 'intMes', 'intAnio', 'vctTasks', 'vctEventos', 'vctMantenimientos', 'vctSolicitudes', 'vctProcesos', 'vctHerramientas', 'vctConsumibles', 'vctRefacciones', 'vctCombustibles'));
    }
