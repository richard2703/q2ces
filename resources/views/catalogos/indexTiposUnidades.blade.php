                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bacTituloPrincipal">
                            <h4 class="card-title">Tipos de Unidades</h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <div class="row">
                                ...
                                <div class="divBorder">
                                    <p>Catálogo General de Tipos de Unidades, Es Utilizado para registrar las unidades de medición utilizadas en el sistema.</p>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-center">
                                                    ...
                                                    @can('catalogos_destroy')
                                                        <form action="{{ route('tiposUnidades.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Añadir Tipo de Unidad</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tiposUnidades.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp <span id="tituloModal">Editar</span> Tipo
                        de Servicio</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tiposUnidades.update', 0) }}" method="post">
                        @csrf
                        @method('put')
