                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="divBorder">
                                    <p>Catálogo General de Marcas, Es Utilizado para Gestionar las Marcas de los Equipos,
                                        Refacciones, Etc. en el
                                        Sistema.</p>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                @can('catalogos_destroy')
                                                    <form action="{{ route('marca.destroy', $item->id) }}" method="POST"
