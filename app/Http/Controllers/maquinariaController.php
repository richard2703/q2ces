...
class maquinariaController extends Controller {
    ...
    */
    ...
    public function store( Request $request ) {
        ...
        for ( $i = 0; $i < count( $request[ 'tipoRefaccionId' ] );
        $i++ ) {
        ...
        */
        ...
        public function show( maquinaria $maquinaria ) {
            ...
            // dd( $maquinaria );
            $obras = obras::select( 'obras.*', 'clientes.nombre as cliente' )
            ->join( 'clientes', 'clientes.id', 'obras.clienteId' )->where( 'obras.clienteId', '<>', 2 )->get();
            //*** Todas excepto la de MTQ control */
            ...
            $tipos = maquinariaTipo::all();
            // dd( $docs );
            return view( 'maquinaria.detalleMaquinaria', compact( 'maquinaria', 'doc', 'fotos', 'obras', 'vctEstatus', 'marcas', 'refaccionTipo', 'refacciones', 'categorias', 'tipos' ) );
        }
        ...
        */
        ...
        public function vista( maquinaria $maquinaria ) {
            ...
            $tipos = maquinariaTipo::all();
            // dd( $docs );
            return view( 'maquinaria.verMaquinaria', compact( 'maquinaria', 'doc', 'fotos', 'obras', 'vctEstatus', 'marcas', 'refaccionTipo', 'refacciones', 'categorias', 'tipos' ) );
        }
        ...
        */
        ...
        public function update( Request $request, maquinaria $maquinaria ) {
            ...
            for ( $i = 0; $i < count( $request[ 'idRefaccion' ] );
            $i++ ) {
                $relacion = inventario::where( 'numparte', $request[ 'numeroParte' ][ $i ] )->first();
