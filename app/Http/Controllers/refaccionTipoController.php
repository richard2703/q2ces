...
class refaccionTipoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $records = refaccionTipo::orderBy('nombre', 'asc')->paginate(15);

        return view('catalogo.indexCatalogoTipoRefaccion', compact('records'));
    }
    ...
    public function store(Request $request)
    {
        ...
        refaccionTipo::create($record);
        Session::flash('message', 1);

        return redirect()->route('catalogoTipoRefaccion.index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $record = refaccionTipo::where('id', $data['controlId'])->first();
    ...
    public function destroy(refaccionTipo $refaccionTipo)
    {
        try {
            $refaccionTipo->delete(); // Intenta eliminar 
