@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Tipos de Equipo')])
@section('content')
    <div class="content">
        @if ($errors->any())
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoEquipo.store') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editarItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tipoEquipo.update', 0) }}" method="post">
                        @csrf
                        @method('put')
