                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row divBorder">
                                            <p>Catálogo General de Ubicaciones de Tareas, Es Utilizado para Asignar la Ubicación en Donde se Tiene que Realizar la Ejecución de una Tarea dentro de un CheckList.</p>
                                        </div>
                                    </div>
