...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-center">
                                                ...
                                                <a href="#" class="" data-bs-toggle="modal"
                                                    ...
                                                    onclick="cargaItem('{{ $item->id }}','{{ $item->nombre }}','{{ $item->ubicacionId }}','{{ $item->comentario }}','{{ $item->activo }}')">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Lugar</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        function cargaItem(id, nombre, ubicacion, comentario, activo) {
