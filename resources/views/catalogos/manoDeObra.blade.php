@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Conceptos de Mano de Obra')])
@section('content')
    <div class="content">
        @if ($errors->any())
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bacTituloPrincipal">
                            <h4 class="card-title">Conceptos de Mano de Obra</h4>
                                ...
                                <div class="col-8 align-end">
                                    @can('catalogos_create')
                                        <button class="btn botonGral float-end" data-bs-toggle="modal"
                                            ...
                                            Añadir Concepto de Mano de Obra
                                        </button>
                                    @endcan
                                </div>

                                <div class="divBorder">
                                    <p>Catálogo General de Conceptos de Mano de Obra Aplicables para los Mantenimientos en
                                        General.</p>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @forelse ($records as $item)
                                        <tr>
                                            ...
                                            <td class="text-left">$ {{ $item->costo }}</td>
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                @can('catalogos_edit')
                                                    <a href="#" class="" data-bs-toggle="modal"
                                                        ...
                                                        onclick="cargaItem('{{ $item->id }}','{{ $item->nombre }}','{{ $item->costo }}','{{ $item->codigo }}','{{ $item->comentario }}')">
                                                ...
                                                @can('catalogos_destroy')
                                                    <form action="{{ route('manoDeObra.destroy', $item->id) }}" method="POST"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('manoDeObra.store') }}" method="post">
                        @csrf
                        ...
                        <div class=" col-12 col-sm-6 col-lg-4 my-3 ">
                            ...
                            <input type="number" step="0.01" min="0.01" max="99999" class="inputCaja text-end" required placeholder="Ej. 100"
    ...
    <div class="modal fade" id="editarItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('manoDeObra.update', 0) }}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class=" col-12 col-sm-6 col-lg-4 my-3 ">
                            <label class="labelTitulo">Costo:</label></br>
                            <input type="number" step="0.01" min="0.01" max="99999" class="inputCaja text-end" required placeholder="Ej. 100"
                                id="controlCosto" name="costo" value="">
                        </div>
    ...
    <script>
        function cargaItem(id, nombre, costo, codigo, comentarios) {
            ...
            const txtTipo = document.getElementById('controlCosto');
            txtTipo.value = costo;
