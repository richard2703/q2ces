                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="divBorder">
                                    <p>Catálogo General de Tipos de Documentos, Es Utilizado para Asignar y Agrupar Todos
                                        los Documentos de Personal y Equipo en un Grupo de Datos.</p>
                                </div>
                            </div>
                                        ...
                                        @forelse ($tiposDocs as $tiposDoc)
                                            <tr>
                                                ...
                                                <td class="td-actions text-center">
                                                    @can('tiposDocs_edit')
                                                        <a href="{{ route('tiposDocs.edit', $tiposDoc->id) }}" class="">
                                                    ...
                                                    @can('tiposDocs_destroy')
                                                        <form action="{{ route('tiposDocs.destroy', $tiposDoc->id) }}"
