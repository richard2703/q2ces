@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Tipos de Uso de Maquinaría')])
@section('content')
    <div class="content">
        @if ($errors->any())
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Tipos de Uso de Maquinaría</h4>
                                            ...
                                            <div class="col-12 text-right">
                                                ...
                                                @can('catalogos_create')
                                                    <button class="btn botonGral float-end" data-bs-toggle="modal"
                                                        ...
                                                        Añadir Tipo de Uso de Maquinaría
                                                    </button>
                                                @endcan
                                            </div>
                                        </div>
                                        <div class="divBorder">
                                            <p>Catálogo General de Uso de Maquinaría, Es Utilizado para Asignar el Uso que
                                                una Maquinaría y/o Equipo Realiza.</p>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('maquinariaTipo.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nueva Tipo de Uso de Maquinaría</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('maquinariaTipo.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Tipo de Uso de Maquinaría</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('maquinariaTipo.update', 0) }}" method="post">
                        @csrf
                        @method('put')
