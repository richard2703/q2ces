@extends('layouts.main', ['activePage' => 'equipos', 'titlePage' => __('Lista de Tipos de Refacciones')])
@section('content')
    <div class="content">
        @if ($errors->any())
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Tipos de Refacciones</h4>
                                            ...
                                            <div class="col-12 text-right">
                                                ...
                                                @can('catalogos_create')
                                                    <button class="btn botonGral float-end" data-bs-toggle="modal"
                                                        ...
                                                        Añadir Tipo de Refacciones
                                                    </button>
                                                @endcan
                                            </div>
                                        </div>
                                        <div class="divBorder">
                                            <p>Catálogo General de Tipos de Refacciones, Es Utilizado para Agrupar y/o
                                                Especificar en un Grupo a las Refacciones.</p>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('refaccionTipo.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Nuevo Tipo de Refacciones</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('refaccionTipo.store') }}" method="post">
                        @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp Editar Tipo de Refacciones</label>
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('refaccionTipo.update', 0) }}" method="post">
                        @csrf
                        @method('put')
