...
@section('content')
                                    ...
                                    <div class="col-10 col-md-5  mx-auto d-block my-4 ">
                                        <div class="row d-flex border">
                                            <div class="col-4 text-center colIcono p-2">
                                                <img src="{{ asset('img/equipos/maquinariaPesada.svg') }}"
                                                    class="mx-auto d-block" width="65%">
                                            </div>
                                            <div class="col-8  p-2">
                                                <h2 class="text-start fs-5 textTitulo">Maquinaria Pesada</h2>
                                                <ul>
                                                    <a class="textEquipo" href="{{ url('detalleEquipo', session('id')) }}">
                                                        <li class="text-start my-3">Retroexcavadora</li>
                                                    </a>
                                                    <a class="textEquipo" href="#">
                                                        <li class="text-start my-3">Camión de Volteo</li>
                                                    </a>
                                                    <a class="textEquipo" href="#">
                                                        <li class="text-start my-3">Pipa de Agua</li>
                                                    </a>
                                                    <a class="textEquipo" href="#">
                                                        <li class="text-start my-3">Camión Orquesta</li>
                                                    </a>
                                                </ul>
                                                            ...
                                                            <div class="row border-bottom justify-content-end">
                                                                <div class="col-3 mb-3">
                                                                    ...
                                                                    <button class="btnSinFondocALENDARIO float-end"
                                                                        data-bs-toggle="modal" data-bs-target="#nuevaTarea">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @forelse ($tareas as $tarea)
                                                                        <tr>
                                                                            ...
                                                                            <td class="labelUrgente">
                                                                                <span>{{ $tarea->prioridadId }}</span>
                                                                            </td>
                                                                            <td class="labelEspera">
                                                                                <span>{{ $tarea->estadoId }}</span>
                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>20/02/2023 </td>
                                                                        <td>23/02/2023 </td>
                                                                        <td class="labelNecesaria"> <span>Necesaria</span>
                                                                        </td>
                                                                        <td class="labelRealizado"> <span>Realizado</span>
                                                                        </td>
                                                                        <td class="td-actions justify-content-end">
                                                                            <a href="#" class=""
                                                                                data-bs-toggle="modal"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="labelTerminado"> <span>Terminado</span>
                                                                        </td>
                                                                        <td class="td-actions justify-content-end">
                                                                            <a href="#" class=""
                                                                                data-bs-toggle="modal"
                            ...
                            <div class="row ">
                                ...
                                <div class=" col-6 col-lg-3 d-flex mb-3">
                                    <input class="" type="radio" name="prioridadId" id="flexRadioDefault1"
                                        value="2">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelNecesaria" for="flexRadioDefault1"> Necesaria
                                        </label>
                                    </div>
                                </div>
                                <div class=" col-6  col-lg-3  d-flex mb-3">
                                    <input class="" type="radio" name="prioridadId" id="flexRadioDefault1"
                                        value="3">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelDeseable" for="flexRadioDefault1"> Deseable
                                        </label>
                                    </div>
                                </div>
                                <div class=" col-6  col-lg-3  d-flex mb-3">
    ...
    <div class="modal fade" id="editarTarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bacTituloPrincipal">
                    <img src="img/calendario/tareagris.svg" class="imgBTNcalendario">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">&nbsp <label name="tareaLblTitulo"></label></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('tareas.update') }}" method="post">
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            ...
                            <input type="text" class="inputCaja" id="tareaTitulo" name="tareaTitulo" value="">
                        </div>
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Responsable:</label></br>
                        ...
                        <div class=" col-12 mb-3 ">
                            ...
                            <div class="row ">
                                <div class=" col-6  col-lg-3 d-flex mb-3">
                                    <input class="" type="radio" name="tareaPrioridadId1" id="tareaPrioridadId1">
                                    <div class=" ms-3">
                                ...
                                <div class=" col-6 col-lg-3 d-flex mb-3">
                                    <input class="" type="radio" name="tareaPrioridadId2" id="tareaPrioridadId2">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelNecesaria" for="tareaPrioridadId2"> Necesaria
                                        </label>
                                    </div>
                                </div>
                                <div class=" col-6  col-lg-3  d-flex mb-3">
                                    <input class="" type="radio" name="tareaPrioridadId3" id="tareaPrioridadId3">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelDeseable" for="tareaPrioridadId3"> Deseable
                                        </label>
                                    </div>
                                </div>
                                <div class=" col-6  col-lg-3  d-flex mb-3">
                                    <input class="" type="radio" name="tareaPrioridadId4" id="tareaPrioridadId4">
                                    <div class=" ms-3">
                        ...
                        <div class="row mb-4">
                            <h4 class="labelTitulo mb-2">Estado de la Solicitud</h4>
                            <div class=" col-6  col-lg-3   d-flex mb-3">
                                <input class="" type="radio" name="tareaEstadoId1" id="tareaEstadoId1">
                                <div class=" ms-3">
                                    <label class="form-check-label labelEspera" for="tareaEstadoId1"> En Espera </label>
                                </div>
                            </div>

                            <div class=" col-6  col-lg-3 d-flex mb-3">
                                <input class="" type="radio" name="tareaEstadoId2" id="tareaEstadoId2">
                                <div class=" ms-3">
                            ...
                            <div class=" col-6  col-lg-3   d-flex mb-3">
                                <input class="" type="radio" name="tareaEstadoId3" id="tareaEstadoId3">
                                <div class=" ms-3">
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Fecha Inicio:</label></br>
                            <input type="date" class="inputCaja" id="tareaFechaInicio" name="tareaFechaInicio">
                        </div>
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Fecha Fin:</label></br>
                            <input type="date" class="inputCaja" id="tareaFechaFin" name="tareaFechaFin">
                        </div>
                        <div class=" col-12  mb-3 ">
                            <label class="labelTitulo">Comentarios:</label></br>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                            <button type="submit" class="btn botonGral">Guardar cambios</button>
                        </div>
                        ...
                        <div class=" col-12 col-lg-6  my-4 ">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-6 d-flex mb-3">
                                    <input class="" type="radio" name="prioridadId" id="flexRadioDefault1">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelRealizado" for="flexRadioDefault1"> Realizado
                                        </label>
                                    </div>
                                </div>
                                <div class=" col-6   d-flex mb-3">
                                    <input class="" type="radio" name="prioridadId" id="flexRadioDefault1">
                                    <div class=" ms-3">
                                        <label class="form-check-label labelTerminado" for="flexRadioDefault1"> Terminado
                                        </label>
                                    </div>
                                </div>
    ...
    <script>
        function loadTarea(id , titulo, responsableId, prioridadId/*, estadoId, fechaInicio, fechaFin, comentarios*/) {
            ...
            // txtComentario.value = comentarios;
        }
    </script>
