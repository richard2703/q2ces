...
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Tipos de Eventos en el Calendario</h4>
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    @can('catalogos_edit')
                                                        <a href="#" class="" data-bs-toggle="modal"
                                                            ...
                                                            onclick="cargaItem('{{ $item->id }}','{{ $item->nombre }}', '{{ $item->color }}','{{ $item->comentario }}','{{ $item->tipoEvento }}')">
                                                    ...
                                                    {{--  @can('catalogos_destroy')
                                                        <form action="{{ route('eventosCalendarioTipos.destroy', $item->id) }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('eventosCalendarioTipos.store') }}" method="post">
                        @csrf
                        {{-- <input type="hidden" name="userId" id="userId" value="{{ $usuario->id }}"> --}}
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Nombre: <span>*</span></label></br>
                            <input type="text" class="inputCaja" id="nombre" name="nombre"
                                value="{{ old('nombre') }}" required placeholder="Especifique..." readonly>
                        </div>
    ...
    <div class="modal fade" id="editarItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex alertaGuardar" action="{{ route('eventosCalendarioTipos.update', 0) }}" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class=" col-12 col-sm-6 mb-3 ">
                            <label class="labelTitulo">Nombre: <span>*</span></label></br>
                            <input type="text" class="inputCaja" id="controlNombre" name="nombre" value="" disabled style="border: gray 1px solid!important;">
                        </div>
    ...
    <script>
        function cargaItem(id, nombre, color, comentarios, tipoEvento) {
        ...
        const txtTipoEvento = document.getElementById('tipoEvento');
        txtTipoEvento.value = tipoEvento;
        }
    </script>
@endsection
