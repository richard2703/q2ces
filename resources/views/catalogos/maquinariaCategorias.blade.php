                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Categorías de Maquinaría</h4>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('maquinariaCategoria.store') }}" method="post">
                        @csrf
    ...
    <div class="modal fade" id="editarItem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row d-flex" action="{{ route('maquinariaCategoria.update', 0) }}" method="post">
                        @csrf
                        @method('put')
