                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            <div>
                                            <a href="{{ url('/nuevaTareaCheck') }}"><!--Agregar ruta-->
                                                <button type="button" class="btn botonGral float-end">Añadir Nueva Revisión</button>
                                            </a></div>
                                            <div>
                                            <a href="#"><!--Agregar ruta-->
                                                <button type="button" class="btn botonGral float-end">Añadir Nuevo Item</button>
                                            </a>
                                        ...
                                        <table class="table">
                                            <thead class="labelTitulo">
                                                <tr>
                                                    ...
                                                    <th class="labelTitulo">Descarga</th>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>boton de descarga </td>

                                                        <td class="td-actions text-right">
                                                           
                                                            <a href="{{ url('/editarTareaCheck') }}" class="">
