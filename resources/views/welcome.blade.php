...
<body>
    {{--  SIRVE PARA MOSTRAR UN SPINNER MIENTRAS CARGA  --}}
    <!-- Spinner Start -->
    <div id="spinner"
    ...
    <!-- Topbar Start -->
    <div class="container-fluid colorF px-0">
        <div class="row g-0 d-none d-lg-flex">
            <div class="col-lg-6 ps-5 text-start">
                <div class="h-100 d-inline-flex align-items-center text-white">
                    ...
                    <a class="btn btn-link text-light" href=" https://www.instagram.com/q2ces/"><i
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('/img/front/carousel-1.jpg') }}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('/img/front/carousel-2.jpg') }}" alt="Image">
                    {{--  <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="d-flex pt-3">
                        <a class="btn btn-square btn-primary rounded-circle me-2 btnF"
                            href="https://www.instagram.com/q2ces"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-square btn-primary rounded-circle me-2 btnF"
                            href="https://www.facebook.com/q2ces"><i class="fab fa-facebook-f"></i></a>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg btn-primary btn-lg-square rounded-circle back-to-top btnF"><i
