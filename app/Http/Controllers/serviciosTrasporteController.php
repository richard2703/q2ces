...
class serviciosTrasporteController extends Controller {
    ...
    */
    ...
    public function index() {
        ...
        return view( 'serviciosTrasporte.indexServicios', compact( 'registros', 'sumaPendientes', 'totalPendientes', 'sumaPagados', 'totalPagados', 'quincena', 'hoy', 'reporte', 'showEncabezado' ) );
    }
    ...
    */
    ...
    public function store( Request $request ) {
        ...
        $objServicio = new serviciosTrasporte();

        // $objInfo = $objServicio->getDetalleNuevo( 15 )  ;
        // dd( $objInfo->titulo, $objInfo->detalle );

        $objServicio = serviciosTrasporte::create( $data );
        $objInfo = $objServicio->getDetalleNuevo( $objServicio->id );

        //*** generar notificacion */
        $objResult = $objNotifica->registrar( $data[ 'personalId' ], $objInfo->titulo, $objInfo->detalle, 'serviciosTrasporte', 'edit',  $objServicio->id );
        $objResult = $objNotifica->registrar( $data[ 'maniobristaId' ], $objInfo->titulo, $objInfo->detalle, 'serviciosTrasporte', 'edit',  $objServicio->id );

        // dd( $data, $objNotifica,  $objResult );
    ...
    */
    ...
    public function cajaChica( Request $request ) {
        ...
        $data[ 'tipo' ] = 2;
        $data[ 'cantidad' ] = $serviciosTrasporte->costoMaterial + $serviciosTrasporte->costoMano;
    ...
    public function misServicios() {
        ...
        return view( 'serviciosTrasporte.indexServicios', compact( 'registros', 'showEncabezado' ) );
    }
