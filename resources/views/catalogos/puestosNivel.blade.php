                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bacTituloPrincipal">
                                    <h4 class="card-title">Niveles de Puestos</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="divBorder">
                                            <p>Catálogo General de Nivel de Puestos, Es Utilizado para Especificar el Tipo
                                                de Acceso y/o Acciones Especificas de un Puesto de Personal en el
                                                Sistema.</p>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        @can('catalogos_destroy')
                                                            <form action="{{ route('puestoNivel.destroy', $item->id) }}"
